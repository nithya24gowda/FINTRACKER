...
<a href="addproject_alloc.php" id ="project_alloc" class="btn button_color <?php echo ((basename($_SERVER['PHP_SELF'])=='project_alloc.php')?'activeSubMenu':'');?>" >&nbsp;Add New</a>  
<br><br>
<table>
        <thead>
          <tr>
        ...
        <tbody>
          <?php while ($row= mysqli_fetch_array($results)){ ?>
            <tr>
              ...
              <td>
                <a class="edit_btn" href="addproject_alloc.php?edit=<?php echo $row['project_id']; ?>">Edit</a>
              </td>
              <td>
                <a class="del_btn" href="serverproject.php?del=<?php echo $row['project_id']; ?>">Delete</a>
              </td>
            </tr>
          <?php }?>
        </tbody>
