...
<header id="header" class="header">
    ...
    <div class="header-menu">
		...
		<div class="col-sm-5 headlines"> 
			<h2><span class="inpro">FIN TRACKER</span></h2>
		...
		<div class="col-sm-3 headlines">
			<div class="headerdropdown" style=" float:right">
				<div class="dropdown float-left " style="display:flex;align-items: center;  ">
				
					<?php if($_SESSION['userType']=='admin') { ?>
                    <label class="admin">Welcome Admin!</label>
					<?php }else if($_SESSION['userType']=='cxo') { ?>
					<label class="admin">Welcome CXO!</label>
					<?php }else if($_SESSION['userType']=='depthead') {   ?>
					<label class="admin">Welcome Department!</label>
					<?php } else if($_SESSION['userType']=='promanager') {   ?>
					<label class="admin">Welcome Manager!</label>
					<?php } else {?>
					<label class="admin">Unknown User!</label>
					<?php } ?>
				</div>
			</div>
		</div>
...
<div class="user-area dropdown float-right" style="margin-top: -16px;">
            <a class="nav-link log-out" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
			<a class="nav-link" href="logout.php"><i class="fa fa-power-off"> LOGOUT </i></a>
		</div>
<?php if($_SESSION['userType']=='promanager') { ?>
	
	 <div class="col-sm-6">	
		<a href="operation.html" class="btn buttons_color bactive"> <i class="fa fa-star"></i>&nbsp; Operations</a>
	</div>
...
<?php } else if($_SESSION['userType']=='cxo') {  ?>
  ...
  <div class="col-sm-6">
		<a href="das.html" class="btn buttons_color bactive"> <i class="fa fa-tachometer "> </i>&nbsp; <span>Dashboard</span></a>
...
<?php } else if($_SESSION['userType']=='depthead') { ?>
	...
	<div class="col-sm-6">
		<a href="dashboard.html" class="btn buttons_color bactive"> <i class="fa fa-tachometer "> </i>&nbsp; <span>Dashboard</span></a>
...
<?php } else if($_SESSION['userType']=='admin') { ?>
	...
	<div class="col-sm-6">
		<a href="configurationuser.php" class="btn buttons_color bactive"> <i class="fa fa-tachometer "> </i>&nbsp; <span>Configuration</span></a>
	</div>
...
<!-- image, logo, scroll text, welcome message  -->



<!-- based on user roles get the appropriate buttons -->
