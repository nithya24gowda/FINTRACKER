...
<a href="addorg_alloc.php" id ="org_alloc" class="btn button_color <?php echo ((basename($_SERVER['PHP_SELF'])=='org_alloc.php')?'activeSubMenu':'');?>" >&nbsp;Add New</a>  
<br><br>
<table>
        <thead>
          <tr>
        ...
        <tbody>
          <?php while ($row= mysqli_fetch_array($results)){ ?>
            <tr>
              ...
              <td>
                <a class="edit_btn" href="addorg_alloc.php?edit=<?php echo $row['org_id']; ?>">Edit</a>
              </td>
              <td>
                <a class="del_btn" href="serverorg.php?del=<?php echo $row['org_id']; ?>">Delete</a>
              </td>
            </tr>
          <?php }?>
        </tbody>
