...
<a href="adduser.php" id ="configuration-user" class="btn button_color <?php echo ((basename($_SERVER['PHP_SELF'])=='configurationuser.php')?'activeSubMenu':'');?>" >&nbsp;Add New</a>  
<br><br>
<table>
        <thead>
          <tr>
        ...
        <tbody>
          <?php while ($row= mysqli_fetch_array($results)){ ?>
            <tr>
              ...
              <td>
                <a class="edit_btn" href="adduser.php?edit=<?php echo $row['user_id']; ?>">Edit</a>
              </td>
              <td>
                <a class="del_btn" href="serveruser.php?del=<?php echo $row['user_id']; ?>">Delete</a>
              </td>
            </tr>
          <?php }?>
        </tbody>
