...
if(isset($_GET['edit'])) {
  ...
  $edit_state=true;
  $rec = mysqli_query($db,"SELECT * FROM project WHERE project_id=$project_id");
...
<a href="addpro.php" id ="configuration-project" class="btn button_color <?php echo ((basename($_SERVER['PHP_SELF'])=='configurationproject.php')?'activeSubMenu':'');?>" >&nbsp;Add New</a>  
<br><br>
<table>
        <thead>
          <tr>
        ...
        <tbody>
          <?php while ($row= mysqli_fetch_array($results)){ ?>
            <tr>
              ...
              <td>
                <a class="edit_btn" href="addpro.php?edit=<?php echo $row['project_id']; ?>">Edit</a>
              </td>
              <td>
                <a class="del_btn" href="serverpro.php?del=<?php echo $row['project_id']; ?>">Delete</a>
              </td>
            </tr>
          <?php }?>
        </tbody>
