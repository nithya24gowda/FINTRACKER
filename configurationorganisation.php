...
<a href="addorg.php" id ="configuration-organisation" class="btn button_color <?php echo ((basename($_SERVER['PHP_SELF'])=='configurationorganisation.php')?'activeSubMenu':'');?>" >&nbsp;Add New</a>  
<br><br>
<table>
        <thead>
          <tr>
        ...
        <tbody>
          <?php while ($row= mysqli_fetch_array($results)){ ?>
            <tr>
              ...
              <td>
                <a class="edit_btn" href="addorg.php?edit=<?php echo $row['org_id']; ?>">Edit</a>
              </td>
              <td>
